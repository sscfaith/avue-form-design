    ...
    <el-form-item label="字典配置"><br>
      <el-tabs v-model="dicOption" stretch @tab-click="handleTabClick">
        <el-tab-pane label="静态数据" name="1">
          <el-tree ref="tree" :data="data.dicData" default-expand-all draggable node-key="value"
            ...
            <span class="custom-tree-node" slot-scope="{ node, data }">
              ...
              <span>
                ...
                <el-button class="danger" type="text" size="mini" icon="el-icon-delete"
      ...
      <el-form ref="dialogForm" :model="dialogForm" label-width="80px">
        ...
        <el-form-item label="value">
          <el-input v-model="dialogForm.value" placeholder="value" :type="this.dialogInputType">
            <el-select v-model="dialogInputType" slot="append" placeholder="数据类型" style="width: 100px">
  ...
  export default {
    ...
    data() {
      return {
        ...
        dicOption: '1',
        dicCopy: deepClone(this.data.dicData),
        dialogForm: {},
        dialogVisible: false,
        dialogRules: {
    ...
    watch: {
      ...
      'data.dicData': {
        handler(val) {
          if (val && val.length > 0 && !Object.is(val, this.dicCopy)) this.dicCopy = deepClone(val)
        },
        deep: true
      }
    }
