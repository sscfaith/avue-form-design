<template>
  <div>
    ...
    <el-form-item label="最小值">
      <el-input-number v-model="data.min" controls-position="right" placeholder="最小值"
                       :max="data.max - 1" :min="0"></el-input-number>
    </el-form-item>
    <el-form-item label="最大值">
      <el-input-number v-model="data.max" controls-position="right" placeholder="最大值"
                       :min="data.min + 1"></el-input-number>
    </el-form-item>
    <el-form-item label="步长">
      <el-input-number v-model="data.step" controls-position="right" placeholder="步长" :min="1"
