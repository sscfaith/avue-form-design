<template>
  <div>
    ...
    <el-form-item label="自定义">
      <el-button type="text" @click="handleDicClear" class="danger">清空</el-button>
      <div class="dic" v-for="(item, index) in data.dicData" :key="index">
        <el-input size="mini" v-model="item.label" placeholder="自定义文字" style="margin-right: 5px"></el-input>
        <el-input size="mini" v-model="item.value" placeholder="自定义值"></el-input>
      </div>
    </el-form-item>
