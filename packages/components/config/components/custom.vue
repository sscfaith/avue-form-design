  ...
  <div class="el-form--label-top">
    <div class="el-form-item el-form-item--small">
      ...
      <div class="el-form-item__content">
        <monaco-editor v-model="params" height="300" :keyIndex="data.prop" :options="options"></monaco-editor>
      </div>
    </div>
    <div class="el-form-item el-form-item--small">
      <label class="el-form-item__label" style="padding: 0;">自定义事件：</label>
      <div class="el-form-item__content">
        <monaco-editor v-model="event" height="300" :keyIndex="data.prop" :options="options"></monaco-editor>
      </div>
    </div>
  </div>
</template>
